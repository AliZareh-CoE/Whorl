...
217. The review page's project-name chips (papers/milestones/etc. on the cross-project view) are now slug-bearing but still render as plain text — they could become Links to the project overview for one-click drill-down, a small consistency win now that the slug is in the payload (idea added during #216)
