...
195. A guard test asserting the wide pages extend base_wide.html (not a bare max-w-5xl) would stop the density width silently regressing if someone copies an old page; cheap grep test (idea added during #183)
