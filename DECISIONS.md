...
154. Density lint — now that .card/.card-title exist, a grep test (like the escape guard) flagging new templates that hand-roll `rounded border border-stone-200 bg-white p-` instead of using the token would keep the rhythm converged (idea added by cycle 143)
