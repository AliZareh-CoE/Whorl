...
## Backlog
200. Count line on the per-project Documents list too (and maybe the matrix) for the same situational-awareness symmetry the lit lists now have (#199) — keep it the same calm stone-400 footnote (idea added during #199)
