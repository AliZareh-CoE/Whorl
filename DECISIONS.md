...
145. Probe for 404s in the browser batteries — the bogus preload URL went unnoticed because nothing watched response codes; layout_verify/spa_verify now listen for >=400 responses, fold the same listener into scripts/editor_smoke.py check 1 (idea added by cycle 134)
