...
## Backlog
193. Reuse remembered_choice for other remembered controls — the reading-queue order ("priority"/"gaps") and any future list toggles could persist the same way now that the helper exists (idea added during #191)
