...
179. Reading-queue + review-matrix density — the remaining literature list surfaces (reading_queue.html, matrix.html) could get the same max-w-6xl + tighter rhythm to finish the #25 sweep across literature (idea added during #171)
