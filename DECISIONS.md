...
206. Doctor could also warn if createUpdaterArtifacts is true but the pubkey is still placeholder (a misconfig that would break the release build) — finer-grained than #203's single check (idea added during #203)
