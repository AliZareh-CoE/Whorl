...
358. Files: edit a text file in place in the pane (`replace_content` exists behind write-file and the Studio; the pane only previews) — a CodeMirror editor with save-as-version and the same diff on save (idea added by #561)
