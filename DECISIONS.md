...
190. Persist the per-project literature order in the session too (like #176 did for the library) so each project remembers how you last ordered its references (idea added during #189)
