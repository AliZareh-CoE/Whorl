...
- Read and highlight without leaving the page; per-project reading notes; Find PDF walks four sources until one serves a real PDF (arXiv → Unpaywall → Semantic Scholar → OpenAlex), fills in a published paper's arXiv id on the way, and says which source answered.
