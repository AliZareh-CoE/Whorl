...
- **Slice in progress:** — (next: Backlog top-down [cycle 52])
...
- **Next 3 slices:**
  1. Backlog top-down [cycle 52] — next undone item (e.g. #30 demo GIF / #31 image slimming — check the list)
  2. Backlog top-down [cycle 53]
