...
- **Slice in progress:** — (next: backlog top-down [cycle 132]: #140 layout presets / #141 CI editor smoke / #137 bundle slim / #25 density passes)
- **Last completed slice (cycle 131, Owner idea #29, UI/UX):** PET VOICE — 🔊 beside the speech bubble on /pet/ and the SPA sidebar speaks the current line via the local Piper /tts/ (200 audio/wav verified on both); strictly opt-in on click, never autoplays. Owner directives #24/#26 core/#27/#28/#29 all delivered.
