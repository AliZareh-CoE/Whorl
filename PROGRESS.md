...
- **Slice in progress:** — (NEXT: #179 reading-queue/matrix density, #177 sortable per-project tables, #176 persist library sort, #181 folder-tree query shape, #159 vite8 dedicated cycle)
