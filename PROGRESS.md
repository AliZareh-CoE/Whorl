...
- **Slice in progress:** — (next: Backlog #21 queue gap-ordering [cycle 41])
...
- **Next 3 slices:**
  1. Backlog #21 — reading-queue "least-covered themes first" ordering [cycle 41]
  2. Backlog #22, #23… top-down (pet hop on milestone check-off, tree grove, …)
