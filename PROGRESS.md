...
- **Slice in progress:** — (next: Owner idea #7 — bots/automations, first slice [cycle 12])
...
- **Next 3 slices:**
  1. Owner idea #7 — bots/automations, first slice [cycle 12]
  2. Owner idea #9 — LaTeX editor, slice 1: cite-key autocomplete [cycle 13]
