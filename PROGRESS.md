...
- **Slice in progress:** — (NEXT: #177 sortable per-project tables, #183 shared list-page wrapper, #187 persist list filters, #181 folder-tree query shape, #159 vite8 dedicated cycle)
