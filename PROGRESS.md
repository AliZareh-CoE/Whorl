...
- **Slice in progress:** — (NEXT: #182 project-literature index density, #177 sortable per-project tables, #176 persist library sort, #183 shared list-page wrapper, #159 vite8 dedicated cycle)
