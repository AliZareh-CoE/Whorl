...
- **Slice in progress:** — (next: Owner idea #7 remainder — citation-sync bot + bot run history [cycle 23])
...
- **Next 3 slices:**
  1. Owner idea #7 remainder — citation-sync bot + bot run history [cycle 23]
  2. Owner idea #9 remainder — LaTeX compile via Tectonic [cycle 24]
  3. #10 PDF-anchored comments, #5 summarization…; ≥2 UI/UX in 21–30; AUDIT #3 at cycle 30
- **Broken:** nothing
