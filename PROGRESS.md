...
- **Slice in progress:** — (NEXT: #180 documents move-select N+1 fix (AUDIT #17 find), #179 reading-queue/matrix density, #177 sortable per-project tables, #176 persist library sort, #159 vite8 dedicated cycle)
