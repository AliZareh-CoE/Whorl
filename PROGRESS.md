...
- **Slice in progress:** — (next: Backlog #24 upload progress bars [cycle 44])
...
- **Next 3 slices:**
  1. Backlog #24 — per-file upload progress bars [cycle 44]
  2. Backlog #25, #26… top-down (suggest keyboard nav, GIN indexes, …)
  3. 2 UI/UX cycles due by cycle 49 (#25 keyboard nav counts as one); AUDIT #5 at cycle 50
- **Broken:** nothing
