...
- **Slice in progress:** — (next: Backlog #14 keyword cloud + queue filters [cycle 35])
...
- **Next 3 slices:**
  1. Backlog #14 — keyword chips → queue filters + project keyword cloud [cycle 35]
  2. Backlog #17, #18, #19… top-down (prompt variables, bot history charts, audit-log page, …)
