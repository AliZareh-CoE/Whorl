...
- **Slice in progress:** — (NEXT: #177 sortable per-project tables, #176 persist library sort, #183 shared list-page wrapper, #181 folder-tree query shape, #159 vite8 dedicated cycle)
