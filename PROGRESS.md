...
- **Slice in progress:** — (next: Owner idea #2 remainder — API-key rotation helper [cycle 22])
...
- **Next 3 slices:**
  1. Owner idea #2 remainder — API-key rotation helper [cycle 22]
  2. Owner idea #7 remainder — citation-sync bot + bot run history [cycle 23]
  3. Then #9 LaTeX compile (Tectonic), #10 PDF comments…; ≥2 UI/UX in 21–30; AUDIT #3 at cycle 30
- **Broken:** nothing
