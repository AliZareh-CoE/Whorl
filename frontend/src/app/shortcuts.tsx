...
export function shortcutGroups(): Group[] {
  return [
    ...
    { title: "Inbox", rows: [["j / k", "Move between captures"], ["↵", "File the highlighted capture where Atlas suggests"], ["1 – 5", "File as paper · today · note · milestone · decision"], ["x", "Dismiss"], ["s", "Snooze until tomorrow"], ["w", "Snooze until next week"], ["space", "Select the highlighted capture"], [`${MOD} A`, "Select every open capture"], ["Esc", "Clear the selection"], [`${MOD} ↵`, "Capture what you typed"]] },
    { title: "Today", rows: [["j / k", "Move between items"], ["space / ↵", "Tick the highlighted item"], ["e", "Edit it"], ["x", "Delete it — into the Trash for 30 days"], ["s / S", "Push it to tomorrow / pick a day or a repeat rule"], ["z", "Undo the last delete, tick or snooze"], ["⌥ ↑ / ↓", "Reorder"], ["n", "New item"]] },
