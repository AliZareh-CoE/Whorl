...
export function shortcutGroups(): Group[] {
  return [
    ...
    { title: "Today", rows: [["j / k", "Move between items"], ["space / ↵", "Tick the highlighted item"], ["e", "Edit it"], ["x", "Delete it"], ["s / S", "Push it to tomorrow / pick a day or a repeat rule"], ["z", "Undo the last delete, tick or snooze"], ["⌥ ↑ / ↓", "Reorder"], ["n", "New item"]] },
