...
export function shortcutGroups(): Group[] {
  return [
    ...
    { title: "Studio", rows: [[`${MOD} S`, "Save"], [`${MOD} ↵`, "Compile"], [`${MOD} ⇧ J`, "Locate the cursor in the PDF"], [`${MOD} B`, "Toggle the sidebar"], [`${MOD} \\`, "Toggle the PDF preview"], [`${MOD} J`, "Toggle the problems panel"], [`${MOD} P`, "Quick open a file or section"]] },
