...
export function WritingBoard() {
  ...
  if (isLoading)
    return <p className="text-sm text-stone-400 dark:text-stone-400">Loading manuscripts…</p>;
...
export function ManuscriptDetail() {
  ...
  if (isLoading || !m)
    return <p className="text-sm text-stone-400 dark:text-stone-400">Loading manuscript…</p>;
    ...
    <div>
      ...
      <div className="mb-2 flex flex-wrap items-center gap-3">
        ...
        <select
          ...
          className="rounded border border-stone-300 bg-white px-2 py-1 text-xs text-stone-600 hover:border-stone-400 focus:border-indigo-600 focus:outline-none dark:border-stone-700 dark:bg-stone-800 dark:text-stone-300"
        >
          {COLUMNS.map(([v, l]) => (
