...
const ORDER = ["reference", "note", "project", "manuscript", "decision", "phase", "milestone", "document", "hypothesis", "experiment", "dataset", "question"];
const LABEL: Record<string, string> = { reference: "Papers", note: "Notes", project: "Projects", manuscript: "Manuscripts", decision: "Decisions", phase: "Phases", milestone: "Milestones", document: "Documents", hypothesis: "Hypotheses", experiment: "Experiments", dataset: "Datasets", question: "Questions" };
