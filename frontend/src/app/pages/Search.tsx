...
const ORDER = ["reference", "note", "project", "manuscript", "decision", "phase", "milestone", "document", "hypothesis", "experiment", "protocol", "dataset", "question", "capture", "comment"];
const LABEL: Record<string, string> = { reference: "Papers", note: "Notes", project: "Projects", manuscript: "Manuscripts", decision: "Decisions", phase: "Phases", milestone: "Milestones", document: "Documents", hypothesis: "Hypotheses", experiment: "Experiments", protocol: "Protocols", dataset: "Datasets", question: "Questions", capture: "Captures", comment: "Comments" };
const TONE: Record<string, string> = { reference: "bg-indigo-500/15 text-indigo-700 dark:text-indigo-200", note: "bg-amber-500/15 text-amber-700 dark:text-amber-300", project: "bg-stone-100 text-stone-600 dark:bg-stone-800 dark:text-stone-300", manuscript: "bg-rose-500/15 text-rose-700 dark:text-rose-300", decision: "bg-emerald-500/15 text-emerald-700 dark:text-emerald-300", phase: "bg-violet-500/15 text-violet-700 dark:text-violet-300", milestone: "bg-violet-500/15 text-violet-700 dark:text-violet-300", document: "bg-sky-500/15 text-sky-700 dark:text-sky-300", comment: "bg-teal-500/15 text-teal-700 dark:text-teal-300" };
