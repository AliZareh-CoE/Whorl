...
def test_notes_client_calls(capture):
    ...
    client.list_notes("deep", tag="#method")
    ...
    assert calls_url_has(capture, "/notes/4/outline/")
    client.get_project_graph("deep")
    assert calls_url_has(capture, "/projects/deep/graph/")
